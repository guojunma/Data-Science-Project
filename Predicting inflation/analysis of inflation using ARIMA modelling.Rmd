...
The goal of this project is to build a statistical model to forecast the inflation rate in Canada. We obtain the macroeconomics data from the website of [International Monetary Policy (IMF)](<https://data.imf.org/?sk=4c514d48-b6ba-49ed-8ab9-52b0c1a0179b&sid=1409151240976>). By analyzing the historical economic and financial data from the website of International Monetary Policy (IMF), we aim to perform statistical inference as well as create a predictive model.

Economic indicators for measuring the inflation rate included the Consumer price index (CPI), the producer price index(PPI) and the GDP deflator. The most commonly used one is CPI, which is defined as the price of one fixed basket of consumer goods and services in one period. CPI includes the cost of food, beverages, housing, education, transportation and medical care. The unit of CPI is measured in percentage, which is compared to the based year. For example, if the base year is $2010$, then the CPI of $125$ means that the price increased by $125$ percent compared to the year $2010$.

We first load the required packages and the economical data:
